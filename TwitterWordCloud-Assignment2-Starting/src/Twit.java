...
public class Twit {
		...
		public Twit(String screenName, String content, double latitude, double longitude, String keyword, long id, String time, String color) {
			this.id = id;
		...
		public String toString() {
			return id + TOKENIZER + screenName + TOKENIZER + latitude + TOKENIZER 
					+ longitude + TOKENIZER + keyword + TOKENIZER + sentiment + TOKENIZER 
					+ time + TOKENIZER + content + TOKENIZER + color ;
		}
