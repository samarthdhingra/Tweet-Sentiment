...
input_text_modified= open('InputFileWithDate.txt', 'r')

#input_text_modified= open('InputFilePreProcessed_2.txt', 'r')

filtered_input_text= open('FilteredInputTextDate.txt', 'w')
...
##filtered_input_text = open('FilteredInputText.txt', 'r')
##
##keywords_count = open('KeywordCounts.txt', 'w')
##
##keywords_dict = {}
##
